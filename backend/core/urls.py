...
from .views import (
    ...
    DailyReviewTodayView,
    DailyPlanContextView,
    FocusSessionViewSet,
    FocusSessionExportView,
    GardenItemListView,
    GardenItemSummaryView,
    GardenOverviewView,
    LoginView,
    LogoutView,
    MoodRecentView,
...
urlpatterns = [
    ...
    path("reviews/today/", DailyReviewTodayView.as_view()),
    path("reviews/context/", DailyPlanContextView.as_view()),
    path("stats/insights/", ProductivityInsightsView.as_view()),
    path("stats/export/", FocusSessionExportView.as_view()),
    path("garden/overview/", GardenOverviewView.as_view()),
    path("garden/items/", GardenItemListView.as_view()),
    path("garden/items/summary/", GardenItemSummaryView.as_view()),
    path("admin/overview/", AdminOverviewView.as_view()),
    path("admin/users/", AdminUserListView.as_view()),
    path("announcements/", PublishedAnnouncementListView.as_view()),
    path("announcements/<int:pk>/read/", AnnouncementMarkReadView.as_view()),
